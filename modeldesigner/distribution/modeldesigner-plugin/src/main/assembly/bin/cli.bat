...
set class_path=%main_path%;%main_path%modeldesigner-plugin.jar
@REM echo ### jvm_opts: %jvm_opts%
@REM echo ### class_path: %class_path%
%JAVA% -classpath %class_path% %jvm_opts% org.openo.commontosca.catalog.mdserver.cmd.CmdMain %allparam%
