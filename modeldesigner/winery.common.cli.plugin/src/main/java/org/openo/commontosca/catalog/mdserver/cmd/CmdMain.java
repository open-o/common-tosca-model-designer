...
import org.openo.commontosca.catalog.mdserver.cmd.entity.BaseParam;
...
//      context.reset();
//      configurator.doConfigure(CmdMain.class.getResource("/").getPath() + File.separator + "conf"
//          + File.separator + "cli.xml");
