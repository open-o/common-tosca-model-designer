...
public class CapabilityTypesYaml2XmlSubSwitch extends AbstractYaml2XmlSubSwitch {
     ...
     * {@link org.opentosca.model.tosca.TCapabilityType} is created and added to
     * the {@link #getDefinitions()} object.
     */
    @Override
    public void process() {
        if (getServiceTemplate().getCapability_types() != null) {
            for (final Entry<String, CapabilityType> capType : getServiceTemplate()
                    .getCapability_types().entrySet()) {
    ...
    /**
     * Creates a Tosca capability type. Sets name and other properties which can
     * be read from
     * {@link org.opentosca.yamlconverter.yamlmodel.yaml.element.CapabilityType}
     * .
     * 
     * @param capType
     *            entry of a capability type in YAML service template
     * @return Tosca capability type
     */
    private TCapabilityType createCapabilityType(
            Entry<String, CapabilityType> capType) {
        ...
        if (capabilityType.getProperties() != null
            ...
            List<WinerysPropertiesDefinition> any = Yaml2XmlSwitchUtils
                    .convert2PropertyDefinitions(capabilityType.getProperties());
