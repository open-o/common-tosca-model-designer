 ...
 * 
 * Bundles all operations required for all components. e.g., namespace+XMLid, object comparison,
 * import, export, tags
 * 
 * Uses a TDefinitions document as storage.
 * 
 * Additional setters and getters are added if it comes to Winery's extensions such as the color of
 * a relationship type
 */
