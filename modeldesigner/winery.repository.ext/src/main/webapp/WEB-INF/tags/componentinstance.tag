...
<t:genericpage windowtitle="${windowtitle}" selected="${selected}" cssClass="mainContentContainer ${cssClass}" libs="${libs}">
	...
	<div>
        <div class="subMenu" style="text-align: right;padding-top: 10px;margin-right: 10px;">
        	<%--
		    <button class="zte-btn zte-white" onclick="openOverviewPage()" id="goBack" data-loading-text="loading...">返回</button>
		    --%>
