...
<br/>
<button class="rightbutton btn btn-danger" type="button" onclick="deleteOnServerAndInTable(reqCapTableInfo, '${labelForSingleItem}', '${url}');">Remove</button>
<button class="rightbutton btn btn-success" type="button" onclick="$('#addReqOrCapDefDiag').modal('show');">Add</button>
...
<div class="modal-content" style="width:660px;">
	<div class="modal-header">
		...
		<h4 class="modal-title">Add <c:choose><c:when test='${labelForSingleItem eq "Capability Definition" }'>Flavor</c:when><c:otherwise>${labelForSingleItem}</c:otherwise></c:choose></h4>
	</div>
...
<thead>
	<tr>
		...
		<th class="sorting_disabled">lower bound</th>
		<th class="sorting_disabled">upper bound</th>
		<th class="sorting_disabled">constraints</th>
	</tr>
</thead>
