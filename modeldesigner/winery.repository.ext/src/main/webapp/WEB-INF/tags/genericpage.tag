...
<head>
	...
	<%-- add paas css --%>
	<link type="text/css" href="${pageContext.request.contextPath}/css/paas.css" rel="stylesheet" />
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/components/editor/built-editor.css"/>
...
function openFirstMenu(){
	...
	if($("#mainMenuContainer").is(':hidden'))
	{
		$("#mainMenuContainer").css("display","");
		$("#styledFirstMenuButtonCenter").removeClass("styledFirstMenuDivunSelected");
		$("#styledFirstMenuButtonCenter").addClass("styledFirstMenuDivSelected");
	}
	else
	{
		$("#mainMenuContainer").css("display","none");
		$("#styledFirstMenuButtonCenter").addClass("styledFirstMenuDivunSelected");
		$("#styledFirstMenuButtonCenter").removeClass("styledFirstMenuDivSelected");
	}
}
</script>
...
<div id="mainContainer">
    ...
    <div class="openoLogoDiv" style="display: none;">
        <img class="open-oLogo"/>
    </div>
    
    <table class="mainContainerTable" style="display: none;">
        <tr>
            <td class="maintableLeftTd" valign="top" style="display:none;">
                <div id="header">
					...
					<div style="margin-bottom: 1px;" onclick="openFirstMenu()">
							<div id="styledFirstMenuButtonCenter" class="styledFirstMenuButton styledFirstMenuDivSelected">Composer</div>
					</div>
					...
					<div id="mainMenuContainer">
						...
						<a class="styledTabMenuButton <c:if test="${selected eq 'ServiceTemplate'}">selected</c:if>" href="${pageContext.request.contextPath}/servicetemplates/">
							<div class="center" style="padding-left:25px; width: 205px;">Service Templates</div>
						</a>
						...
						<a class="styledTabMenuButton <c:if test="${selected eq 'NodeType'}">selected</c:if>" href="${pageContext.request.contextPath}/nodetypes/">
							<div class="center" style="padding-left:25px; width: 205px;">Node Types</div>
						</a>
						...
						<a class="styledTabMenuButton <c:if test="${selected eq 'RelationshipType'}">selected</c:if>" href="${pageContext.request.contextPath}/relationshiptypes/">
							<div class="center" style="padding-left:25px; width: 205px;">Relationship Types</div>
						</a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default mybtn" data-dismiss="modal">Cancel</button>
				<button type="button" class="btn btn-primary mybtn" data-dismiss="modal" onclick="addResourceInstance();">Add</button>
			</div>
		</div>
	</div>
</div>
            ...
            <td class="maintableRightTd" valign="top">
	            <div id="mainContent">
				<jsp:invoke fragment="libs"></jsp:invoke>
					<div class="${cssClass}">
					<jsp:doBody/>
