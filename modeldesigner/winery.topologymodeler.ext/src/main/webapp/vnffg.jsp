...
<%
	...
	// TRelationshipType relationshipForwardsTo = null;
	// TRelationshipType relationshipVirtualLinksTo = null;
	// for(TRelationshipType currentRelationship : relationshipTypes) {
	// 	if("tosca.relationships.nfv.ForwardsTo".equals(currentRelationship.getName())) {
	// 		relationshipForwardsTo = currentRelationship;
	// 	}

	// 	if("tosca.relationships.nfv.VirtualLinksTo".equals(currentRelationship.getName())) {
	// 		relationshipVirtualLinksTo = currentRelationship;
	// 	}
	// }
	// relationshipTypes.clear();
	// relationshipTypes.add(relationshipForwardsTo);
	// relationshipTypes.add(relationshipVirtualLinksTo);
...
<head>
	...
	<link rel="stylesheet" href="components/bootstrap/dist/css/dataTables.bootstrap.css" />
	...
	<link rel="stylesheet" type="text/css" href="components/built-editor/built-editor.css"/>
...
<script>
	require.config({
		...
		paths: {
			...
			//"orioneditor": "../components/built-editor/built-editor-amd.min",
			...
			"jquery.i18n": "../components/jquery.i18n/jquery.i18n.properties-1.0.9"
...
<div id="winery">
	...
	<div id="topbar" style="margin-left:0;">
		<a class="zte-btn zte-white" id="exportCSARbtn" onclick="goBack('<%=topologyTemplateURL%>')" href="javascript:void(0)">
			<span id="winery-toolbar-btn-return" name_i18n="winery_i18n"></span>
		</a>
		<button class="zte-btn zte-white" onclick="showAddNfpDialog();">
			<span id="winery-vnffg-btn-addnfp" name_i18n="winery_i18n"></span>
		</button>
		<button class="zte-btn zte-white" onclick="editNfpAttri();">
			<span id="winery-vnffg-btn-property" name_i18n="winery_i18n"></span>
		</button>
		<button class="zte-btn zte-white" onclick="savePath();">
			<span id="winery-vnffg-btn-save" name_i18n="winery_i18n"></span>
		</button>
		...
		<div class="btn-group" style="margin-bottom:5px;">
			<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false" style="height:30px;">
				<span id="selectedPath" style="color:#238dfa;">Path</span> <span class="caret"></span>
			</button>

			<ul class="dropdown-menu" role="menu" id="pathList">
	...
	<t:palette client="<%=client%>" relationshipTypes="<%=relationshipTypes%>" repositoryURL="<%=repositoryURL%>" ns="<%=ns%>" autoConnect="<%=autoConnect%>"/>
...
<!--
		<div style="height:40%">
			<table id="nfpTable" class="table table-striped table-bordered table-hover">  
			  <thead>  
			    <tr>  
			      <th><span id="winery-vnffg-table-name" name_i18n="winery_i18n"></span></th>  
			      <th><span id="winery-vnffg-table-type" name_i18n="winery_i18n"></span></th> 
			      <th><span id="winery-vnffg-table-path" name_i18n="winery_i18n"></span></th>  
...
<script>
	...
	jsPlumb.bind("ready", function() {
		...
		jsPlumb.bind("click", function(conn, originalEvent) {
			var labelId = $(conn.getOverlay("label").getElement()).text();
	    	$("#pathIndex").val(labelId);
			...
			conn.getOverlay("label").setLabel(labelId);
		});
	// jsPlumb.ready
	});
	</script>
...
<tmpl:registerConnectionTypesAndConnectNodeTemplates relationshipTemplates="<%=relationshipTemplates%>" relationshipTypes="<%=relationshipTypes %>" ondone="onDoneRegisterConnectionTypesAndConnectNodeTemplates();" repositoryURL="<%=repositoryURL%>" autoConnect="<%=autoConnect%>"/>
...
<div class="modal fade" id="addNFPDialog">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title">
					<span id="winery-vnffg-dialog-title" name_i18n="winery_i18n"></span>
				</h4>
			</div>
			<div class="modal-body">
				...
				<form class="form-horizontal">
					<div class="form-group">
						<div class="col-sm-3 control-label">
							<label for="name" class="control-label">
								<span id="winery-vnffg-dialog-nodetype" name_i18n="winery_i18n"></span>
					...
					<div class="form-group">
						<div class="col-sm-3 control-label">
							<label for="name" class="control-label">
								<span id="winery-vnffg-dialog-nfpname" name_i18n="winery_i18n"></span>
								<span class="required" aria-required="true">*</span>
							</label>
						</div>
						<div class="col-sm-7">
							<input type="text" class="form-control" id="nfpName"> 
						</div>
			...
			<div class="modal-footer">
				<button type="button" class="zte-btn zte-white" data-dismiss="modal">
					<span id="winery-btn-cancel" name_i18n="winery_i18n"></span>
				</button>
				<button type="button" class="zte-btn zte-primary" onclick="addNfp()">
...
<script type='text/javascript' src='vnffg.js'></script>
	</body>
</html>
