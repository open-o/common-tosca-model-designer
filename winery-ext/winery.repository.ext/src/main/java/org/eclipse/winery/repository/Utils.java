...
public class Utils {
	 ...
	 * @param uri
	 */
	public static Response getDefinitionsOfSelectedResource(final AbstractComponentInstanceResource resource, final URI uri,final ExportFileGenerator extendPoint) {
	...
	public static Response getCSARDeployResource(final AbstractComponentInstanceResource resource) {
		...
		try {
			...
			String fileName = path + "/" + resource.getXmlId().getEncoded()
	...
	public static Set<Class<? extends RepositoryUploadService>> getRepositoryServiceImpl(){
        ...
        return reflections.getSubTypesOf(
                org.eclipse.winery.repository.ext.repository.RepositoryUploadService.class);
	}
	...
	public static TDefinitions getDefiniton(String namespace,String id,Class<? extends AbstractComponentsResource> containerClass){
	    Class<? extends TOSCAComponentId> idClass = getComponentIdClassForComponentContainer(containerClass);
