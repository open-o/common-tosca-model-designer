...
public class InputsXml2YamlSubSwitch extends AbstractXml2YamlSubSwitch {
    ...
    private Entry<String, org.eclipse.winery.repository.ext.yamlmodel.Input> createInput(
        ...
        return buildEntry(Xml2YamlTypeMapper.mappingNodeType(tInput.getName()),
                yInput);
    }

    private Entry<String, org.eclipse.winery.repository.ext.yamlmodel.Input> buildEntry(
            String name,
            org.eclipse.winery.repository.ext.yamlmodel.Input yInput) {
        Map<String, org.eclipse.winery.repository.ext.yamlmodel.Input> map = new HashMap<>();
        map.put(name, yInput);
