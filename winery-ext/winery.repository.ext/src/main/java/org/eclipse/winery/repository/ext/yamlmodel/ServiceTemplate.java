...
public class ServiceTemplate extends YAMLElement {
    ...
    private Map<String, Object> data_types = new HashMap<>();
    ...
    private Map<String, Object> policy_types = new HashMap<>();
    ...
    public void setData_types(Map<String, Object> data_types) {
    ...
    public void setPolicy_types(Map<String, Object> policy_types) {
