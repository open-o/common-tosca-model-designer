...
<div class="tab-content">
	...
	<div class="tab-pane active" id="options">
		<div style="margin: 5px;">
		    <button class="rightbutton btn btn-danger" name="remove" onclick="deleteOnServerAndInTable(optionsTableInfo, 'Option', 'selfserviceportal/options/', 0, 1);">Remove</button>
			<button class="rightbutton btn btn-success" name="add" onclick="$('#addOptionDiag').modal('show');">Add</button>
		...
		<table id="optionsTable"  style="margin-top: 5px;">
			<thead>
				<tr>
					<th class="plan_td">Id</th>
					<th class="plan_td">Name</th>
					<th class="plan_td">Icon</th>
					<th class="plan_td">Plan Service Name</th>
				</tr>
			</thead>
			<tbody>
