	...
	require(["winery-datatable", "jquery.fileupload"], function(wd) {
		...
		var operationInputRender = function(obj) {
			var operationHtml = '<i class="fa fa-edit icon-del" data-row="'
				...
				+ '<i class="fa fa-check icon-del" title="确定" style="margin-right:3px;display:none;"></i>'
			  	+ '<i class="fa fa-trash icon-del" title="删除"></i>';
		...
		var inputInfo = {
			...
			columns : [
				...
				{"mData": "desc", "name": "描述", "sWidth" : "25%", "sClass": "edit"},
				{"mData": "value", "name": "默认值", "sWidth" : "25%", "sClass": "edit"},
		...
		var operationMetaRender = function(obj) {
			...
			if(obj.aData.tag != "inherit") {
			  	operationHtml += '<i class="fa fa-trash icon-del" data-row="'+obj.iDataRow+'" title="删除"></i>';
			}
			return operationHtml;
		}
		...
		var metaInfo = {
			...
			columns : [
				{"mData": "key", "name": "名称", "sWidth" : "35%"},
				{"mData": "required", "name": "是否必填", "sWidth" : "20%", "fnRender" : requiredRender},
				{"mData": "value", "name": "值", "sClass": "edit"},
